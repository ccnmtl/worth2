...
def remove_empty_submission(user, section):
    """Remove an empty submission for validation purposes.

    Returns True if any empty submissions in the given section were
    removed, and this is a Protective Behaviors page. Otherwise, returns
    False.
    """
    ...
    pageblocks = section.pageblock_set.filter(
